(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-zoomImg", [], factory);
	else if(typeof exports === 'object')
		exports["react-zoomImg"] = factory();
	else
		root["react-zoomImg"] = factory();
...
var Win = window;
var windowW = Win.innerWidth;
var windowH = Win.innerHeight;
...
// 计算最大缩放宽
var computedMaxWidth = exports.computedMaxWidth = function computedMaxWidth(_ref) {
...
// 获取缩放比例
var getScale = exports.getScale = function getScale(_ref2) {
    ...
    // 要缩放的宽度
    var scaleWidth = computedMaxWidth({ naturalWidth: naturalWidth });
    return (scaleWidth / width).toFixed(4);
};

// 禁止滚动
var forbadeScroll = exports.forbadeScroll = function forbadeScroll() {
    var overflowH = Win.getComputedStyle(html).overflow;
    var overflowB = Win.getComputedStyle(body).overflow;
...
exports.default = _zoomImg2.default;
...
var _EventsWrapper = __webpack_require__(40);

var _EventsWrapper2 = _interopRequireDefault(_EventsWrapper);

var _Zoom = __webpack_require__(41);
...
var ZoomImg = function (_React$Component) {
    _inherits(ZoomImg, _React$Component);

    function ZoomImg(props) {
        _classCallCheck(this, ZoomImg);

        var _this = _possibleConstructorReturn(this, (ZoomImg.__proto__ || Object.getPrototypeOf(ZoomImg)).call(this, props));
    ...
    _createClass(ZoomImg, [{
        ...
        value: function render() {
            ...
            return [_react2.default.createElement('img', { key: 'image',
                ...
                } }), (isZoomed || this.isClosing) && _react2.default.createElement(
                _EventsWrapper2.default,
                {
                    key: 'portal',
                    ref: function ref(p) {
                        return _this2.portalInstance = p;
                    }
                },
...
ZoomImg.propTypes = {
    ...
    // 高清图地址 不传使用src
    hdSrc: _propTypes.string,
    // 默认样式
    defaultStyles: _propTypes.object,
    // 配置
    option: (0, _propTypes.shape)({
        // 进入与离开的时间
        animateTime: _propTypes.number,
        // 离开风格 未实现
        leaveStyle: _propTypes.string
    }),
    // 图片组
    imageSet: (0, _propTypes.arrayOf)(_propTypes.object),
    // 懒加载  未实现 暂不使用
    lazy: (0, _propTypes.shape)({
        // 是否懒加载
        isLazy: _propTypes.bool,
        // 懒加载封面图
        loading: _propTypes.string
    }),
    // ------是否放大----- 暂不使用
...
var _utlis = __webpack_require__(18);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // 事件盒子


var PortalImg = function (_Component) {
    _inherits(PortalImg, _Component);

    function PortalImg(props) {
        _classCallCheck(this, PortalImg);

        var _this = _possibleConstructorReturn(this, (PortalImg.__proto__ || Object.getPrototypeOf(PortalImg)).call(this, props));

        _this.portal = (0, _utlis.createPortalContainer)('div');
        _this.unzoom = _this.unzoom.bind(_this);
        return _this;
    }

    _createClass(PortalImg, [{
        key: 'componentDidMount',
        value: function componentDidMount() {}
    }, {
        key: 'componentWillUnmount',
        value: function componentWillUnmount() {
            (0, _utlis.removePortalContainer)(this.portal);
        }
    }, {
        key: '_cloneChild',
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // 弹出层
...
var Zoom = function (_Component) {
    ...
    _createClass(Zoom, [{
        ...
        value: function _getZoomImageStyle() {
            ...
            // 图片中心
            var imageCenterX = left + width / 2;
            var imageCenterY = top + height / 2;

            // 偏移位置
            var translateX = viewportX - imageCenterX;
            var translateY = viewportY - imageCenterY;

            var scale = (0, _utlis.getScale)({
                width: width,
                height: height,
            ...
            if (!this.state.hasLoaded || !this.state.isZoomed) {
                return _extends({}, defaultStyles.zoomImage, style);
            }
            ...
            return _extends({}, defaultStyles.zoomImage, style, zoomStyle);
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(ImgContainer, _extends({
                    className: 'zoom-img'
...
Zoom.defaultProps = {
    ...
    zoomImage: {},
    option: {
        animationTime: _config2.default.transitionDuration
    }
};
...
var ImgContainer = _styledComponents2.default.img(_templateObject2, function (props) {
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // 遮罩层
...
var Overlay = function (_Component) {
    ...
    _createClass(Overlay, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
            return nextProps.isVisible !== this.state.isVisible || nextProps.isVisible !== this.props.isVisible;
        }
    }, {
        key: '_getStyle',
        value: function _getStyle() {
            // 将透明度转为 0 || 1
            var opacity = this.state.isVisible & 1;
            var overlay = this.props.defaultStyles.overlay;

            return _extends({}, overlay, { opacity: opacity });
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement(OverlayContainer, {
                animationTime: _config2.default.transitionDuration,
...
var OverlayContainer = _styledComponents2.default.div(_templateObject, function (props) {
    return props.animationTime;
});
